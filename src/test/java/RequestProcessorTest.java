...
public class RequestProcessorTest {
    ...
    public void get_empty_session_from_cookie1() {
        assertEquals(EMPTY_STRING, RequestProcessor.getSessionFromCookies("nt-length:34807\n" +
    ...
    public void get_empty_cookie2() {
        assertEquals(EMPTY_STRING, RequestProcessor.getSessionFromCookies("status:200\n" +
                "vary:Accept-Encoding\n" +
                "x-content-type-options:nosniff\n" +
                "Cookie:"));
    }
